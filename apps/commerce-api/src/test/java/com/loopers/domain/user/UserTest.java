    ...
    class CreateUserTest {
        ...
        class IdTest {
            ...
            void createUser_withNoEngAndNumId_BadRequest() {
                ...
                assertEquals("ID에 영문과 숫자만 10자 이내로 꼭 포함되어 있어야 합니다.", result.getCustomMessage());
            }
        ...
        class EmailTest {
            ...
            void createUser_withNoAtSignEmail_BadRequest() {
                ...
                // assert
                assertEquals(ErrorType.BAD_REQUEST, result.getErrorType());
                assertEquals("email이 `xx@yy.zz` 형식에 맞아야 합니다.", result.getCustomMessage());
            }
        ...
        class BirthdayTest {
            ...
            void createUser_withNoHyphenBirthday_BadRequest() {
                ...
                // assert
                assertEquals(ErrorType.BAD_REQUEST, result.getErrorType());
                assertEquals("birthday가 `yyyy-MM-dd` 형식에 맞아야 합니다.", result.getCustomMessage());
            }
